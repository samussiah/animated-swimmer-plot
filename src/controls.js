export default function controls() {
    ...
    this.settings.timepoint = this.settings.timepoint !== undefined && this.settings.timepoint >= this.settings.timepointMin && this.settings.timepoint <= this.settings.timepointMax
