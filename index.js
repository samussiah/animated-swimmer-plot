(function (global, factory) {
    ...
    function groups() {
        ...
        return function (_ref, transition) {
            ...
            return (g = g
                .data(
                    groupByResponse.call(this, data),
                    function (d) {
                        _newArrowCheck(this, _this2);
                            ...
                            .attr(
                                ...
                                function (d) {
                                    ...
                                    return 'translate('
                                        ...
                                        .concat(this.scale.y(d[1].rankMin), ')');
                                }.bind(this)
                            )
                            .call(
                                function (g) {
                                    ...
                                    g.append('text')
                                        ...
                                        .attr('text-anchor', 'end')
                                        .attr('alignment-baseline', 'middle')
                                        .attr('x', -10) //.attr('y', this.scale.y.bandwidth() / 2 + 1)
                                        .attr(
                                            'y',
                                            function (d) {
                            ...
                            .attr(
                                ...
                                function (d) {
                                    ...
                                    return 'translate('.concat(
                                        0,
                                        ',',
                                        this.scale.y(d['rank'.concat(this.settings.view)]),
                                        ')'
                                    );
                                }.bind(this)
                            );
    ...
    function axis() {
        ...
        return function (_, transition) {
            ...
            this.layout.xAxisTop
                .selectAll('.tick line')
                .attr('stroke', '#999')
                .attr('stroke-opacity', 0.6); //this.layout.xAxisTop.select('.domain').remove();
                            ...
                            .attr(
                                ...
                                function (d) {
                                    ...
                                    return 'translate('.concat(
                                        0,
                                        ',',
                                        this.scale.y(this.set.id.size + 1),
                                        ')'
                                    );
                                }.bind(this)
                            );
        ...
        return function (_ref, transition) {
            ...
            transition.end().then(
                function () {
                    ...
                    this.layout.ticker.text('Day '.concat(timepoint));
                    this.active = false;
                }.bind(this)
            );
        }.bind(this);
    ...
    function transitionAnimation(timepoint) {
        ...
        var transition = this.layout.svg
            .transition()
            .duration(this.settings.duration)
                        ...
                        while (1) {
                            switch ((_context.prev = _context.next)) {
                                ...
                                case 3:
                                    ...
                                    this.layout.ticker.text('Day '.concat(this.settings.timepoint));
                                    delete this['break'];
    ...
    function init() {
        ...
        this.layout.n
            ...
            .attr('x', -10)
            .attr('y', 10)
            .text('n='.concat(this.set.id.size));
        this.update = {
    ...
    function canvas(main) {
        ...
        var svg = this.util
            ...
            .attr('viewBox', [0, 0, this.settings.width, this.settings.height]); //.attr('width', this.settings.width)
