(function (global, factory) {
            ...
            function (d) {
                ...
                datum.result_order =
                    d[this.settings.result_order_var] !== undefined
                        ...
                        : datum.result === 'PD'
                        ? 5
                        : null; // TODO: use a variable from the data
                ...
                group
                    .sort(
                        function (a, b) {
                            ...
                            return (
                                state_order_diff || total_duration_diff || duration_diff || id_diff
                            );
                        }.bind(this)
                    )
                    .forEach(
                ...
                group
                    .sort(
                        function (a, b) {
                            ...
                            var id_diff = a.id < b.id ? -1 : 1;
                            return (
                                state_order_diff || duration_diff || total_duration_diff || id_diff
                            );
                        }.bind(this)
                    )
                    .forEach(
    ...
    function controls() {
        ...
        this.settings.timepointMin = d3.min(
        ...
        this.settings.timepointMax = d3.max(
            this.data.timepoints,
            function (_ref3) {
                _newArrowCheck(this, _this);
