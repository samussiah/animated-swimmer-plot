(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es.object.assign.js'), require('core-js/modules/es.function.bind.js'), require('core-js/modules/es.array.join.js'), require('core-js/modules/es.array.concat.js'), require('core-js/modules/es.array.map.js'), require('core-js/modules/es.array.filter.js'), require('core-js/modules/es.array.sort.js'), require('core-js/modules/es.array.for-each.js'), require('core-js/modules/web.dom-collections.for-each.js'), require('core-js/modules/es.string.iterator.js'), require('core-js/modules/es.array.iterator.js'), require('core-js/modules/web.dom-collections.iterator.js'), require('core-js/modules/es.array.flat-map.js'), require('core-js/modules/es.array.unscopables.flat-map.js'), require('core-js/modules/es.array.find.js'), require('core-js/modules/es.object.to-string.js'), require('core-js/modules/es.promise.js'), require('core-js/modules/es.set.js'), require('core-js/modules/es.array.reverse.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.split.js'), require('core-js/modules/es.object.keys.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/es.array.includes.js')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.object.assign.js', 'core-js/modules/es.function.bind.js', 'core-js/modules/es.array.join.js', 'core-js/modules/es.array.concat.js', 'core-js/modules/es.array.map.js', 'core-js/modules/es.array.filter.js', 'core-js/modules/es.array.sort.js', 'core-js/modules/es.array.for-each.js', 'core-js/modules/web.dom-collections.for-each.js', 'core-js/modules/es.string.iterator.js', 'core-js/modules/es.array.iterator.js', 'core-js/modules/web.dom-collections.iterator.js', 'core-js/modules/es.array.flat-map.js', 'core-js/modules/es.array.unscopables.flat-map.js', 'core-js/modules/es.array.find.js', 'core-js/modules/es.object.to-string.js', 'core-js/modules/es.promise.js', 'core-js/modules/es.set.js', 'core-js/modules/es.array.reverse.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.split.js', 'core-js/modules/es.object.keys.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/es.array.includes.js'], factory) :
  ...
  function layout$1(main, width) {
    var canvas = this.util.addElement('canvas', main);
    var svg = this.util.addElement('svg', canvas, 'svg').attr('viewBox', [0, 0, width, this.settings.height]); //.attr('width', width)
    ...
    var labels = this.util.addElement('g--labels', svg, 'g').style('font', 'bold 12px var(--sans-serif)').style('font-variant-numeric', 'tabular-nums').attr('text-anchor', 'start');
    var ticker = this.util.addElement('ticker', svg, 'text').attr('text-anchor', 'end').attr('x', width - 18).attr('y', this.settings.height - this.settings.margin.bottom - 36).attr('dy', '0.32em'); //.text(`Day ${this.data.timepoints[0][0]}`);
    ...
    return function (_ref, transition) {
      ...
      return groups = groups.data(groupByResponse.call(this, plot, data), function (d) {
        ...
        return enter.append('g').attr('transform', function (d) {
          ...
          return "translate(".concat(this.settings.margin.left, ",").concat(plot.scale.y(d[1].rankMin), ")");
          ...
          //    .text((d) => `${d[0]}`);
          g.append('text').classed('asp-text asp-text--percent', true).attr('text-anchor', 'end').attr('alignment-baseline', 'middle').attr('x', -10) //.attr('y', plot.scale.y.bandwidth() / 2 + 1)
          .attr('y', function (d) {
  ...
  function bars(plot) {
    ...
    return function (_ref, transition) {
      ...
      bars = bars.data(data, function (d) {
        ...
        return enter.append('g').attr('height', plot.scale.y.bandwidth()).attr('y', plot.scale.y(plot.set.id.size));
      }.bind(this), function (update) {
        _newArrowCheck(this, _this2);
        ...
        g.selectAll('rect').data(function (d) {
          ...
          return rect.transition(transition).duration(this.settings.duration).attr('x', function (d) {
            ...
            return plot.scale.x(d.start_timepoint + d.duration) - plot.scale.x(d.start_timepoint);
          }.bind(this));
        }.bind(this));
      }.bind(this));
    }.bind(this);
  ...
  function axis(plot) {
    ...
    //    .text(`ID`);
    var xAxisTop = d3.axisTop(plot.scale.x).ticks(this.settings.width / 160).tickSizeOuter(0).tickSizeInner(-(this.settings.height - this.settings.margin.top - this.settings.margin.bottom));
    var xAxisBottom = d3.axisBottom(plot.scale.x).ticks(this.settings.width / 160).tickSizeOuter(0).tickSizeInner(0);
    return function (_, transition) {
      ...
      plot.layout.xAxisTop.selectAll('.tick line').attr('stroke', '#999').attr('stroke-opacity', 0.6); //plot.layout.xAxisTop.select('.domain').remove();
  ...
  function plot(data) {
    ...
    var layout = layout$1.call(this, this.layout.plots, this.settings.width);
    var set = {
    ...
    layout.n.attr('transform', function (d) {
      _newArrowCheck(this, _this);

      return "translate(".concat(this.settings.margin.left, ",").concat(this.settings.margin.top / 2, ")");
    }.bind(this)).append('text').attr('text-anchor', 'end').attr('alignment-baseline', 'middle').attr('x', -10).attr('y', 10).text("n=".concat(set.id.size));
    var plot = {
      data: data,
      layout: layout,
      set: set,
  ...
  function init() {
    ...
    this.plots = this.settings.stratum_var !== undefined ? d3.groups(this.data.mutated, function (d) {
      _newArrowCheck(this, _this);

      return d.stratum;
    }.bind(this)).map(function (_ref) {
      var _this2 = this;
      ...
      var timepoints = this.data.timepoints.map(function (_ref3) {
        var _this3 = this;
      ...
      var plot$1 = plot.call(this, data);
      plot$1.stratum = stratum;
      return plot$1;
    }.bind(this)) : [_objectSpread2(_objectSpread2({}, plot.call(this, this.data)), {}, {
      stratum: ''
    })];
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _loop = /*#__PURE__*/regeneratorRuntime.mark(function _loop() {
                ...
                var timepoint, allStates, x1, x2, xDomain, transitions;
                return regeneratorRuntime.wrap(function _loop$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        timepoint = _step.value;
                        updateTimepoint.call(_this4, timepoint[0]); // Break loop.
                        ...
                        _this4.plot.layout.svg.interrupt();

                        _this4.plot.layout.ticker.text("Day ".concat(_this4.settings.timepoint));

                        delete _this4["break"];
                        return _context.abrupt("return", "break");

                      case 7:
                        allStates = _this4.data.interpolated.flatMap(function (d) {
                          _newArrowCheck(this, _this5);

                          return d["states".concat(_this4.settings.view)];
                        }.bind(this));
                        ...
                        xDomain = [x1, x2];
                        transitions = _this4.plots.map(function (plot) {
                          var _this6 = this;

                          _newArrowCheck(this, _this5);

                          plot.data.timepoint = plot.data.timepoints.find(function (_ref5) {
                            ...
                            return timepoint === _this4.settings.timepoint;
                          }.bind(this));
                          return transitionAnimation.call(_this4, plot, xDomain);
                        }.bind(this));
                        _this4.transition = transitions;
                        _context.next = 15;
  ...
  function range(form) {
    ...
    input.on('change', function () {
      ...
      transitionAnimation.call(main, main.data.timepoint); //}, this.settings.duration);
    });
    return {
      input: input,
      output: output
  ...
  function view(controls) {
    ...
    inputs.on('change', function () {
      ...
      this.data.timepoints.forEach(function (_ref) {
        var _this3 = this;
  ...
  function resize() {
    ...
    this.plot.layout.svg.attr('width', this.settings.dimensions.width).attr('height', this.settings.dimensions.height);
  }
  ...
  function layout() {
    ...
    var legend = this.util.addElement('legend', main).style('left', "".concat(this.settings.margin.left, "px"));
  ...
  function groupByTimepoint(interpolated, finalTimepoint) {
    ...
    var timepoints = d3.rollups(interpolated, function (group) {
      ...
      var groupIds = new Set(group.map(function (d) {
        ...
        return d.id;
      }.bind(this))); // If ID is missing at given timepoint, add final record to 
      ...
      }.bind(this)); // Define mutable rank given current view.
