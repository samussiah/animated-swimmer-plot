(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es.object.assign.js'), require('core-js/modules/es.function.bind.js'), require('core-js/modules/es.array.join.js'), require('core-js/modules/es.array.concat.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.split.js'), require('core-js/modules/es.array.map.js'), require('core-js/modules/es.array.filter.js'), require('core-js/modules/es.array.for-each.js'), require('core-js/modules/web.dom-collections.for-each.js'), require('core-js/modules/es.array.flat-map.js'), require('core-js/modules/es.array.unscopables.flat-map.js'), require('core-js/modules/es.array.find.js'), require('core-js/modules/es.array.iterator.js'), require('core-js/modules/es.object.to-string.js'), require('core-js/modules/es.promise.js'), require('core-js/modules/es.string.iterator.js'), require('core-js/modules/web.dom-collections.iterator.js'), require('core-js/modules/es.set.js'), require('core-js/modules/es.array.sort.js'), require('core-js/modules/es.array.reverse.js'), require('core-js/modules/es.object.keys.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/es.array.includes.js')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.object.assign.js', 'core-js/modules/es.function.bind.js', 'core-js/modules/es.array.join.js', 'core-js/modules/es.array.concat.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.split.js', 'core-js/modules/es.array.map.js', 'core-js/modules/es.array.filter.js', 'core-js/modules/es.array.for-each.js', 'core-js/modules/web.dom-collections.for-each.js', 'core-js/modules/es.array.flat-map.js', 'core-js/modules/es.array.unscopables.flat-map.js', 'core-js/modules/es.array.find.js', 'core-js/modules/es.array.iterator.js', 'core-js/modules/es.object.to-string.js', 'core-js/modules/es.promise.js', 'core-js/modules/es.string.iterator.js', 'core-js/modules/web.dom-collections.iterator.js', 'core-js/modules/es.set.js', 'core-js/modules/es.array.sort.js', 'core-js/modules/es.array.reverse.js', 'core-js/modules/es.object.keys.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/es.array.includes.js'], factory) :
  ...
  function legend() {
    ...
    swatches.each(function (d, i) {
      ...
      var svg = swatch.append('svg').attr('width', "".concat(width, "px")).attr('height', "".concat(width, "px"));
      if (i === 0) svg.append('text').attr('x', 0).attr('y', 0).attr('alignment-baseline', 'hanging').attr('fill', 'black').style('font-weight', 'bold').style('font-size', width / 4).text(main.settings.criteria);
      svg.append('rect').attr('x', 0).attr('y', width / 4).attr('width', width).attr('height', width - width / 4).attr('fill', function (d) {
        _newArrowCheck(this, _this);
  ...
  function layout$1(plot) {
    ...
    }.bind(this)).append('text').attr('text-anchor', 'middle').attr('alignment-baseline', 'middle').attr('y', 5).text(plot.stratum !== '' ? "".concat(plot.stratum) : null); //.text(plot.stratum !== '' ? `${this.settings.stratum_var} = ${plot.stratum}` : null);
    ...
    }.bind(this)).append('text').attr('text-anchor', plot.settings.textAnchor).attr('alignment-baseline', 'middle').attr('x', plot.settings.sign * 10).attr('y', 5);
    ...
    var ticker = this.util.addElement('ticker', svg, 'text').attr('text-anchor', plot.settings.mirror ? 'start' : 'end').attr('x', plot.settings.mirror ? plot.settings.margin.left + 18 : plot.settings.width - plot.settings.margin.right - 18).attr('y', this.settings.height - this.settings.margin.bottom - 36).attr('dy', '0.32em'); //.text(`Day ${this.data.timepoints[0][0]}`);
    ...
    return function (_ref, transition) {
      ...
      return groups = groups.data(groupByResponse.call(this, plot, data), function (d) {
        ...
        return enter.append('g').attr('transform', function (d) {
          ...
          g.append('text').classed('asp-text asp-text--percent', true).attr('text-anchor', plot.settings.textAnchor).attr('alignment-baseline', 'middle').attr('x', plot.settings.sign * 10).attr('y', function (d) {
            _newArrowCheck(this, _this4);
          ...
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              this.plots.forEach(function (plot) {
                ...
                plot.layout.ticker.text("Day ".concat(this.settings.timepoint));
              }.bind(this));
              delete this["break"];
  ...
  function resize() {
    ...
    this.plots.forEach(function (plot) {
      ...
      plot.layout.ticker.attr('x', plot.settings.mirror ? plot.settings.margin.left + 18 : plot.settings.width - plot.settings.margin.right - 18);
