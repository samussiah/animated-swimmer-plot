(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined'
        ...
        : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
          (global.animatedSwimmerPlot = factory()));
})(this, function () {
    'use strict';
    ...
    function addElement(name, parent) {
        ...
        return data
            ? parent
                  .selectAll(''.concat(tagName, '.asp-').concat(name, '.asp-').concat(tagName))
                  .data(data, id)
                  .join(tagName)
                  .classed('asp-'.concat(name, ' asp-').concat(tagName), true) // multiple elements
    ...
    function addIcon(parent, icon) {
        ...
        var path = parent
            .append('svg')
            .attr('width', ''.concat(this.settings.buttonSize, 'px'))
            .attr('height', ''.concat(this.settings.buttonSize, 'px'))
            .append('g')
            .append('path')
            .attr(
                'transform',
    ...
    function settings() {
        return {
            ...
            sort: 'CurrentResponse',
            // ['CurrentResponse', 'Best Response']
            split: 'vertical',
            // ['vertical', 'horizontal']
            splitFactor: 1,
            play: true,
            ...
            new Set(
                data.map(
                    function (d) {
                        ...
                        return ''
                            .concat(d.result_order, '|')
                            .concat(d.result, '|')
                            .concat(d.result_color);
                    }.bind(this)
                )
            ).values()
        )
    ...
    function legend() {
        var main = this;
        var width = this.settings.width / this.scale.color.domain().length;
        var height = 50;
    ...
    function layout$1(plot) {
        ...
        var title = this.util
            ...
            .attr(
                ...
                function (d) {
                    ...
                    return 'translate('
                        .concat(
                            plot.settings.translateX, //plot.settings.margin.left +
            ...
            .attr('y', 5)
            .text(plot.stratum !== '' ? ''.concat(plot.stratum) : null); //.text(plot.stratum !== '' ? `${this.settings.stratum_var} = ${plot.stratum}` : null);
        ...
        var n = this.util
            ...
            .attr(
                ...
                function (d) {
                    ...
                    return 'translate('
                        .concat(plot.settings.translateX, ',')
                        .concat(this.settings.margin.top / 2, ')');
                }.bind(this)
            )
            .append('text') //.attr('text-anchor', plot.settings.textAnchor)
            .attr('text-anchor', 'middle')
            .attr('alignment-baseline', 'middle') //.attr('x', plot.settings.sign * 10)
            .attr('x', (plot.settings.sign * plot.settings.strokeWidth) / 2)
            .attr('y', 5);
        var groups = this.util
        ...
        var xAxisTop = this.util
            ...
            .attr('transform', 'translate(0,'.concat(this.settings.margin.top, ')')); //.call((g) =>
        //    this.util
            ...
            .call(
                function (g) {
                    ...
                    return this.util
                        ...
                        .text(
                            plot.settings.mirror
                                ? '\u2190 Time ('.concat(this.settings.timepointUnit, 's)')
                                : 'Time ('.concat(this.settings.timepointUnit, 's) \u2192')
                        );
                }.bind(this)
            );
        ...
        var labels = this.util
            .addElement('g--labels', svg, 'g')
            .style('font', 'bold 12px var(--sans-serif)')
            .style('font-variant-numeric', 'tabular-nums')
            .attr('text-anchor', 'start'); //const ticker = this.util
    ...
    function data$2(data, stratum) {
        ...
        var interpolated = this.data.interpolated.filter(
            function (d) {
                _newArrowCheck(this, _this);
        ...
        var timepoints = this.data.timepoints.map(
            function (_ref) {
                var _this2 = this;
                ...
                var stratumData = data
                    ...
                    .sort(
                        function (a, b) {
                            ...
                            return (
                                a['rank'.concat(this.settings.view)] -
                                b['rank'.concat(this.settings.view)]
                            );
                        }.bind(this)
                    );
                stratumData.forEach(
    ...
    function groupByResponse(plot, data) {
        ...
        var groupedByResponse = d3.rollups(
            data,
            function (group) {
                var _this2 = this;
    ...
    function groups(plot) {
        ...
        return function (_ref, transition) {
            ...
            return (groups = groups
                .data(
                    groupByResponse.call(this, plot, data),
                    function (d) {
                        _newArrowCheck(this, _this2);
                        ...
                        return enter
                            ...
                            .attr(
                                ...
                                function (d) {
                                    ...
                                    return 'translate('
                                        .concat(plot.settings.translateX, ',')
                                        .concat(plot.scale.y(d[1].rankMin), ')');
                                }.bind(this)
                            )
                            .call(
                                function (g) {
                                    ...
                                    g.append('line')
                                        ...
                                        .attr(
                                            'x1',
                                            (plot.settings.sign * plot.settings.strokeWidth) / 2
                                        )
                                        .attr(
                                            'x2',
                                            (plot.settings.sign * plot.settings.strokeWidth) / 2
                                    ...
                                    g.append('text')
                                        .classed('asp-text asp-text--percent', true) //.attr('text-anchor', plot.settings.textAnchor)
                                        .attr('text-anchor', 'middle')
                                        .attr('alignment-baseline', 'middle') //.attr('x', plot.settings.sign * 10)
                                        .attr(
                                            'x',
                        ...
                        g.select('text.asp-text--percent')
                            ...
                            .text(
                                function (d) {
                                    ...
                                    return this.settings.redact_numbers
                                        ? 'n (xx%)'
                                        : ''.concat(d[1].n, ' (').concat(d[1].pct, ')');
                                }.bind(this)
                            );
                        g.select('line.asp-line--group')
                            .transition(transition)
                            .duration(this.settings.duration)
                            .attr(
                                'y2',
                            ...
                            .attr(
                                ...
                                function (d) {
                                    ...
                                    return 'translate('.concat(
                                        0,
                                        ',',
                                        plot.scale.y(d['rank'.concat(plot.stratum)]),
                                        ')'
                                    );
                                }.bind(this)
                            );
            ...
            labels = labels
                            ...
                            .attr(
                                ...
                                function (d) {
                                    ...
                                    return 'translate('.concat(
                                        0,
                                        ',',
                                        plot.scale.y(plot.set.id.size + 1),
                                        ')'
                                    );
                                }.bind(this)
                            );
                ...
                .call(
                    function (label) {
                        ...
                        return label.transition(transition).attr(
                            'transform',
                            function (d) {
                                _newArrowCheck(this, _this5);
    ...
    function plot() {
        ...
        plot.settings = {
            ...
            margin: _objectSpread2(
                _objectSpread2({}, this.settings.margin),
                {},
                {
        ...
        plot.settings.strokeWidth =
            i === 0 ? plot.settings.margin.right : plot.settings.margin.left;
        ...
        plot.layout.n.text(this.settings.redact_numbers ? 'N=xx' : 'N='.concat(plot.set.id.size));
        plot.update = {
    ...
    function updateTimepoint(timepoint) {
        ...
        this.data.timepoint = this.data.timepoints.find(
            function (d) {
                _newArrowCheck(this, _this);
        ...
        this.layout.ticker.text(
            ''
                .concat(this.settings.timepointPrefix, ' ')
                .concat(this.settings.timepointUnit, ' ')
                .concat(timepoint)
        );
                            ...
                            switch ((_context.prev = _context.next)) {
                                case 0:
                                    _iterator = _createForOfIteratorHelper(
                                        this.data.timepoints.filter(
                                            function (d) {
                                                _newArrowCheck(this, _this2);

                                                return (
                                                    d[0] >= this.settings.timepoint &&
                                                    d[0] <= this.settings.timepointMax
                                                );
                                            }.bind(this)
                                        )
                                    );
    ...
    function transitionAnimation(plot) {
        var transition = plot.layout.svg
            .transition()
            .duration(this.settings.duration)
            .ease(d3.easeLinear); // Update the x-domain.
    ...
    function playPause(form) {
        ...
        button.on(
            ...
            function () {
                ...
                if (this.settings.play === false && this['break'] === undefined)
                    this['break'] = true;
    ...
    function view(controls) {
        ...
        inputs.on(
            ...
            function () {
                ...
                var allStates = this.data.interpolated.flatMap(
                    function (d) {
                        _newArrowCheck(this, _this2);
    ...
    function mapVariables(d) {
        ...
        var _iterator = _createForOfIteratorHelper(
                Object.keys(this.settings).filter(
                    function (key) {
                        _newArrowCheck(this, _this);
    ...
    function interpolate(mutated) {
                    ...
                    .forEach(
                        function (d, i) {
                            ...
                            for (var _i = 0; _i < d.duration; _i++) {
                                ...
                                datum.statesOverallSurvival = states.map(
                                    function (state) {
                                        _newArrowCheck(this, _this3);
                                ...
                                datum.statesCurrentResponse = currentResponse(
                                    datum.statesOverallSurvival
                                );
        ...
        var flattened = _toConsumableArray(interpolated.values()).flatMap(
            function (d) {
                _newArrowCheck(this, _this);
        ...
        group
            .sort(
                function (a, b) {
                    ...
                    return (
                        a['rank'.concat(this.settings.view)] - b['rank'.concat(this.settings.view)]
                    );
                }.bind(this)
            )
            .forEach(
    ...
    function controls() {
        ...
        this.settings.timepointMin =
            this.settings.timepointMin !== null
                ? this.settings.timepointMin
                : d3.min(
        ...
        this.settings.timepointMax =
            this.settings.timepointMax !== null
                ? this.settings.timepointMax
                : d3.max(
                      this.data.timepoints,
                      function (_ref3) {
        ...
        controls.range.output.text(
            ''.concat(this.settings.timepointUnit, ' ').concat(this.settings.timepoint)
        );
        return controls;
    }
